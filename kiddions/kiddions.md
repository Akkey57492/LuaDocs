...
例
```
globals.get_boolean(Integer index)
```
返り型
```
bool
...
例
```
globals.get_float(Integer index)
```
返り型
```
number
...
例
```
globals.get_uint(Integer index)
```
返り型
```
integer
...
例
```
globals.set_boolean(Integer index, bool value)
```
返り型
```
nil
...
例
```
globals.set_float(Integer index, Number value)
```
返り型
```
nil
...
例
```
globals.set_int(Integer index, Integer value)
```
返り型
```
nil
...
例
```
globals.set_uint(Integer index, Integer value)
```
返り型
```
nil
